...
`phase-2.21-home-showcase`; PR [#36](https://github.com/petarjakimov11012011-cell/Trajanov-V2/pull/36) open to `main`, awaiting the other
operator's review — `D-0-3`; NOT merged, NOT deployed).** The pieces now sit on the front door: between the hero and the FAQ, in the
