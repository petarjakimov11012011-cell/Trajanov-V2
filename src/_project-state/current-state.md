...
**Phase Y.05 — Home hero: full-bleed photograph with overlaid CTAs — CODE COMPLETE (2026-07-27,
branch `phase-y.05-home-hero-overlay`; PR open to `main` — operator merges, `D-0-3`).** The Home hero
