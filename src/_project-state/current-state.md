...
| Branch | `phase-2.05-cutover` → PR **#15 MERGED to `main`** (merge `49fe2ca`, 2026-07-22) on Petar's instruction; branch deleted. Prior: `phase-2.04b-seo-geo-polish` → PR `#14`, merged `c562195` (2026-07-22); `phase-2.04-perf-a11y-seo` → PR `#13`, merged `6375a0d` (2026-07-20) |
| Open PR | **None.** `#15` merged (2026-07-22). Prior merged: 1.01–1.07 `#1`–`#7`; Z.01 `#8`; 1.08 `#9`; 2.01 `#10`; 2.02 `#11`; 2.03 `#12`; 2.04 `#13`; 2.04b `#14`; 2.05 `#15` |
