...
(`D-2.25-17`, WCAG 2.1.1); and the two mis-stated claims are corrected by `D-2.25-18`. Two further
...
diff. **Placeholder register unchanged.** New owed **#59–#63**. Decisions `D-2.25-5…18`.
