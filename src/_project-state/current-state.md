...
Branch `phase-2.06-rehearsal-contingency`; **PR open to `main`, not self-merged (`D-0-3`).** The
owed-verification register gains no new rows (the rehearsal is what verifies the existing #15/#16); the
...
| Branch | `phase-2.06-rehearsal-contingency` → **PR #16 open to `main` (not self-merged, `D-0-3`)**. Prior: `phase-2.05-cutover` → PR **#15 MERGED** (`49fe2ca`, 2026-07-22); `phase-2.04b-seo-geo-polish` → PR `#14`, merged `c562195` (2026-07-22) |
| Open PR | **#16 — 2.06** (`phase-2.06-rehearsal-contingency` → `main`, opened 2026-07-22, awaiting an operator merge). Prior merged: 1.01–1.07 `#1`–`#7`; Z.01 `#8`; 1.08 `#9`; 2.01 `#10`; 2.02 `#11`; 2.03 `#12`; 2.04 `#13`; 2.04b `#14`; 2.05 `#15` |
